...
class Woo_Inecobank_Admin {
    ...
    public function admin_notices() {
        ...
        if ( $gateway->enabled === 'yes' ) {
            ...
            $username = $testmode ? $gateway->get_option( 'test_username' ) : $gateway->get_option( 'username' );
            $password = $testmode ? $gateway->get_option( 'test_password' ) : $gateway->get_option( 'password' );
            ...
            if ( $testmode ) {
                ...
                <div class="notice notice-warning">
                    <p>
                        <?php _e( 'Inecobank Payment Gateway is in test mode. Remember to switch to live mode for production.', 'woo-inecobank-payment-gateway' ); ?>
                    </p>
                </div>
                <?php
            }
